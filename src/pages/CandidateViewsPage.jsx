...
export default function CandidateViewsPage() {
  return (
    <Layout>
      <div className="flex-container">
        <div className="item">
          ...
          <h4 className="underline">2024 General Election is on Tuesday November 5th, 6 am – 6 pm</h4>
          <ul>
            <li>Early voting begins October 8th. Find location &amp; hours at your local County Election Office.</li>
            <li>Register to Vote or Check Voting Status at the <a href="https://indianavoters.in.gov/">Indiana Voter Portal</a>. Check Voting Status will also show who's on your ballot and voting locations.</li>
          </ul>
          <CandidateViewsContent staticData={data} />
        </div>
      </div>
    </Layout>
  );
