    ...
    <Layout>
      <div className="flex-container">
        <div className="item">
          ...
          <p>Almost every major university in Indiana has an Office of Sustainability to address reduction of carbon emissions.</p>
          <p>
        ...
        <div className="item">
          <ul>
            <li><a href="/docs/Campaign-Funds-from-coal-and-utility-industries.pdf" download>Campaign Funds from coal and utility industries</a></li>
            <li><a href="/docs/Solar-Voting-Record-SB309.pdf" download>Solar Voting Record - SB309</a></li>
          </ul>
        </div>
      </div>
    </Layout>
